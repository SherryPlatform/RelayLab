...
This document applies to all versions of RelayLab.
...
The build number is the number of days since July 9, 2025 because the first
version of RelayLab is created and published on that day.
